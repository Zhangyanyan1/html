(function(document){
    ...
    function Game(config){
        ...
        this.row = (config.row%2?Math.abs(config.row)+1:Math.abs(config.row)) || 8;
        this.col = (config.col%2?Math.abs(config.col)+1:Math.abs(config.col)) || 8;
        this.img = config.img || 12;
        this.gezi = [];
